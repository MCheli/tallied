      ...
      <div v-if="selectedW2 && (v(selectedW2.base_salary) > 0 || v(selectedW2.rsu_income) > 0)"
          ...
          <div class="flex-1">
            ...
            <div class="h-8 rounded-lg overflow-hidden flex">
              <div class="bg-indigo-500 h-full flex items-center justify-center text-white text-xs font-medium px-2"
                :style="{ width: `${v(selectedW2.base_salary) / v(selectedW2.gross_pay) * 100}%` }">
              ...
              <div class="bg-green-500 h-full flex items-center justify-center text-white text-xs font-medium px-2"
                :style="{ width: `${v(selectedW2.rsu_income) / v(selectedW2.gross_pay) * 100}%` }">
        ...
        <div class="flex gap-6 text-xs">
          <div class="flex items-center gap-1.5">
            ...
            <span class="text-gray-400">({{ fmtPct(v(selectedW2.base_salary) / v(selectedW2.gross_pay) * 100) }})</span>
          </div>
          <div class="flex items-center gap-1.5">
            ...
            <span class="text-gray-400">({{ fmtPct(v(selectedW2.rsu_income) / v(selectedW2.gross_pay) * 100) }})</span>
          </div>
        </div>
      </div>
