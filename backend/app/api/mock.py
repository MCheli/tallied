...
def mock_accounts():
    ...
    return {
        "accounts": [
            ...
            {"id": "401k-001", "name": "Nexus 401(k)", "type": "retirement", "balance": 185432.50, "institution": "Fidelity"},
            {"id": "inv-001", "name": "Nexus Brokerage", "type": "investment", "balance": 49500.00, "institution": "E-Trade"},
